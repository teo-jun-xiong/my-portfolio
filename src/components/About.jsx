...
function About() {
    return <div id="about-me" className="about">
        <img src={programmer} alt="about-me" className="header-img" /><br/>
        <h3 className="project-header header-shadow">About Me</h3><br/>
        ...
        Below are some of my projects and skills I've picked up, and please feel free to contact me using the links <a href="#links">here</a> if you have any questions or would like to get in touch. Thank you for visiting my portfolio page!</p>
    </div>
}
